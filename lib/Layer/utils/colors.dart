...
class AppColors {
  ...
  static final Color mainColor = const Color(0xff3889bf);
  ...
  static final Color bBgColor = const Color(0xFFf7f6f4);
  ...
  static final Color btnColor = const Color(0xff31384f);
}