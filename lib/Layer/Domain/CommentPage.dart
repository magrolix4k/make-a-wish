  ...
  Future<void> fetchCommentData() async {
    try {
      ...
      if (commentText.isNotEmpty && _userRating > 0) {
        ...
        print('place_id ' +_currentPlace!);
        print('user_id ' +_currentUser_id!);
        print('comment_text ' +commentText);
        print('imageName ' +_imagename!);
        print('comment_image ' +_imagedata!);
        print('comment_rating ' +_userRating.toString());
